...
[[CopyArtifactPlugin-Version1.47]]
=== 1.47

Release date: Aug 14, 2022

* Targets Jenkins 2.319.3 and later (was 2.164.3 and later) (https://github.com/jenkinsci/copyartifact-plugin/pull/150[#150])

[[CopyArtifactPlugin-Version1.46.4]]
=== 1.46.4

Release date: Apr 23, 2022

* Support icon images with jenkins-2.333 and later. (https://github.com/jenkinsci/copyartifact-plugin/pull/147[#147])

[[CopyArtifactPlugin-Version1.46.3]]
=== 1.46.3

Release date: Mar 13, 2022

* Compatibility with jenkins-2.339 and later. (https://github.com/jenkinsci/copyartifact-plugin/pull/145[#145]).
* Internal changes:
** Use Maven3 for tests. (https://github.com/jenkinsci/copyartifact-plugin/pull/142[#142])
** Compile time compatibility with jenkins-2.325 and later. (https://github.com/jenkinsci/copyartifact-plugin/pull/143[#143])
** Use findbugs annotations instead of jsr-305 annotations. (https://github.com/jenkinsci/copyartifact-plugin/pull/144[#144])
